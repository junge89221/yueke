package cn.bry.yueke.view.widget;
...
public class SplashView extends FrameLayout {
    ...
    private static final String ACT_TYPE = "splash_act_type";
    ...
    void initComponents() {
        ...
        splashSkipButtonBg.setColor(Color.parseColor("#0D000000"));
        View view = LayoutInflater.from(mActivity).inflate(R.layout.welcome_bg_layout, this, false);
        splashImageView = (ImageView) view.findViewById(R.id.ad_image);
        ...
        this.addView(view, imageViewLayoutParams);
        ...
        skipButton.setTextColor(mActivity.getResources().getColor(R.color.ColorFFFF));
    ...
    private void setOnSplashImageClickListener(@Nullable final OnSplashViewActionListener listener) {
        ...
        splashImageView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onSplashImageClick(actUrl,actType);
            }
        });
    }
    ...
    public static void showSplashView(@NonNull Activity activity,
        ...
        if (isExistsLocalSplashData(activity)) {
            ...
            splashView.setActType(sp.getString(ACT_TYPE, null));
    ...
    private void dismissSplashView(final boolean initiativeDismiss) {
...
//        final ViewGroup parent = (ViewGroup) this.getParent();
       /* if (null != parent) {
            ObjectAnimator animator = ObjectAnimator.ofFloat(SplashView.this, "scale", 0.0f, 0.35f).setDuration(600);
            animator.start();
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    SplashView.this.setScaleX(1.0f + 2.0f *cVal);
                    SplashView.this.setScaleY(1.0f + 2.0f *cVal);
                }
            });
    ...
    private void showSystemUi() {
        if(mOnSplashViewActionListener!=null) mOnSplashViewActionListener.onsplashViewEnd();
//        mActivity.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
     ...
     */
    public static void updateSplashData(@NonNull Activity activity, @NonNull String imgUrl, @Nullable String actionUrl, @NonNull String actType) {
        SharedPreferences sharedPreferences = activity.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
          SharedPreferences.Editor editor = sharedPreferences.edit();
        IMG_PATH = activity.getFilesDir().getAbsolutePath().toString() + "/splash_img.jpg";
        editor.putString(IMG_URL, imgUrl);
        editor.putString(ACT_URL, actionUrl);
        editor.putString(ACT_TYPE, actType);
        editor.apply();
        if(!TextUtils.isEmpty(imgUrl)) getAndSaveNetWorkBitmap(imgUrl);
    }

    public interface OnSplashViewActionListener {
        void onSplashImageClick(String actionUrl, String actionType);
